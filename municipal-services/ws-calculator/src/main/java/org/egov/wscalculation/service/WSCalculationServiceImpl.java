...
//		}
		...
		if(request.getIsAdvanceCalculation() != null && request.getIsAdvanceCalculation().booleanValue()) {
			demandService.generateDemand(request.getRequestInfo(), calculations, masterMap,
					request.getIsconnectionCalculation(), isWSUpdateSMS, request.getIsAdvanceCalculation(), false);
		}else {
			demandService.generateDemand(request.getRequestInfo(), calculations, masterMap,
					request.getIsconnectionCalculation(), isWSUpdateSMS, false, false);
		}
	...
	public List<Calculation> bulkDemandGeneration(CalculationReq request, Map<String, Object> masterMap) {
		...
		demandService.generateDemand(request.getRequestInfo(), calculations, masterMap, true, false, request.getIsAdvanceCalculation(), request.getIsAdvanceDemand());
		return calculations;
	}
